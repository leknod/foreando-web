 ...
 *   - pillStatic: static pill classes for Hero
...
export const categoryColors = {
  adultos: {
    ...
    pillStatic: "border-rose-200 bg-card/80 text-rose-700",
    dot: "bg-rose-500",
  ...
  deportes: {
    ...
    pillStatic: "border-emerald-200 bg-card/80 text-emerald-700",
    dot: "bg-emerald-500",
  ...
  "economia-finanzas": {
    ...
    pillStatic: "border-amber-200 bg-card/80 text-amber-700",
    dot: "bg-amber-500",
  ...
  fotografia: {
    ...
    pillStatic: "border-fuchsia-200 bg-card/80 text-fuchsia-700",
    dot: "bg-fuchsia-500",
  ...
  general: {
    ...
    pillStatic: "border-blue-200 bg-card/80 text-blue-700",
    dot: "bg-blue-500",
  ...
  motor: {
    ...
    pillStatic: "border-red-200 bg-card/80 text-red-700",
    dot: "bg-red-500",
  ...
  "ocio-entretenimiento": {
    ...
    pillStatic: "border-violet-200 bg-card/80 text-violet-700",
    dot: "bg-violet-500",
  ...
  otros: {
    ...
    pillStatic: "border-slate-200 bg-card/80 text-slate-700",
    dot: "bg-slate-500",
  ...
  "tecnologia-informatica": {
    ...
    pillStatic: "border-cyan-200 bg-card/80 text-cyan-700",
    dot: "bg-cyan-500",
