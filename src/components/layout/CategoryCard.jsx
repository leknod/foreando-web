    ...
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      ...
      <div className="flex-1 py-2 pl-2">
        {category.forums?.slice(0, 10).map((forum, index) => (
          ...
          >
            <span className="w-5 text-xs font-medium font-mono text-foreground-subtle">
              {index + 1}.
            </span>
            <Link
      ...
      <Link
        ...
        className="flex items-center justify-center gap-1 border-t border-border bg-card-muted px-3 py-2.5 text-sm font-medium text-foreground-muted transition-colors hover:bg-card-hover hover:text-primary"
      >
